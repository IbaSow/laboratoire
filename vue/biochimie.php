...
<span class="input-group-btn">
<a class="btn" href="new_prescripteur_bi.php"><span class="glyphicon glyphicon-plus"></span></a>
	</span>
	</div>
...
<span class="input-group-btn">
<a class="btn" href="new_service_bi.php"><span class="glyphicon glyphicon-plus"></span></a>
	</span>
...
<td><input type="date" name="bi_daterendue"  style="width:250px"  id="prescripteur" >
</td>
