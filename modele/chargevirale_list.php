...
?>
	...
	<tr class="success">
		...
		<td class="col-md-1" style="width:450px"><a target="_blank"href="page_cv_impression.php?page=<?php echo $donnees['cv_numero'];?>">Imprimer</a></td>
		<td class="col-md-1" style="width:450px"><a target="_blank"href="page_cv_suppression.php?page=<?php echo $donnees['cv_numero'];?>">Supprimer</a></td>
	</tr>
