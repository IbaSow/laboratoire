...
nl.nl_prescripteur prescripteur,nl.nl_technique technique,nl.nl_unite unite,nl.nl_conclusion conclusion,nl.nl_remarque remarque,sv.sv_libelle service_libelle,th.th_libelle technique_libelle,nl.nl_unite unite,
nl.nl_norme norme,nl.nl_cd4 cd4,nl.nl_cd8 cd8,nl.nl_cd3 cd3,nl.nl_rapport rapport,
...
while ($donnees=$reponse->fetch())
{
 ?>	
	...
	<tr>
		...
		<td><?php echo htmlentities($donnees['conclusion']);?></td>
	</tr>
	<tr>
		<td style="padding:5px 5px 5px 5px;font-weight:bold;"><?php echo 'Remarques:'  ?></td>
		<td><?php echo htmlentities($donnees['remarque']);?></td>
	</tr>
	<tr>
