...
?>
	...
	<tr class="success">
		<td class="col-md-1" style="width:450px"><?php echo $donnees['dossier'];?>
		</td>
		<td class="col-md-1" style="width:450px"><?php echo $donnees['jour_r'].'/'.$donnees['mois_r'].'/'.$donnees['annees_r'];?>
		</td>
		<td class="col-md-1" style="width:450px"><a target="_blank"href="page_gr_impression.php?page=<?php echo $donnees['gr_numero'];?>">Imprimer</a></td>
				<td class="col-md-1" style="width:450px"><a target="_blank"href="page_gr_suppression.php?page=<?php echo $donnees['gr_numero'];?>">Supprimer</a></td>
	</tr>
