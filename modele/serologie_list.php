...
?>
	...
	<tr class="info">
		<td style="width:450px"><?php echo $donnees['dossier'];?>
		</td>
		<td style="width:450px"><?php echo $donnees['jour_r'].'/'.$donnees['mois_r'].'/'.$donnees['annees_r'];?>
		</td>  
		<td style="width:450px"><a target="_blank"href="page_sr_impression.php?page=<?php echo $donnees['sr_numero'];?>">Imprimer</a></td>
				<td style="width:450px"><a target="_blank"href="page_sr_suppression.php?page=<?php echo $donnees['sr_numero'];?>">Supprimer</a></td>
	</tr>
