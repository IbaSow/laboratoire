...
while ($donnees=$reponse->fetch())
{
 ?>	
	...
	<tr>
		...
		<td style="padding-bottom:10px;padding-right:10px;"><?php echo htmlentities($donnees['libelle_projet']);?></td>
	</tr>
	<tr>
...
<td style="padding-bottom:10px;padding-right:10px;font-weight:bold;"><?php echo 'Technique:'  ?></td>
	...
	<table>
 <tr>
		<td colspan="2" style="padding-left:150px;padding-bottom:20px;font-size:15px;font-weight:bold;">RESULTATS SEROLOGIE RETROVIRALE</td>
	...
	<tr>
		...
		<td style="padding-bottom:10px;padding-right:10px;"><?php echo htmlentities($donnees['hiv12']);?></td>
	</tr>
	<tr>
 ...
 <tr>
		<td colspan="2" style="padding-left:150px;padding-bottom:20px;font-size:15px;font-weight:bold;">RESULTATS HEPATITE</td>
	...
	<tr>
		<td style="padding-bottom:10px;padding-right:10px;font-weight:bold;"><?php echo 'Conclusion:'  ?></td>
		<td style="padding-bottom:10px;padding-right:10px;"><?php echo htmlentities($donnees['conclusion_ag']);?></td>
	</tr>
	<tr>
