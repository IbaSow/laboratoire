...
?>
<page backtop="0%" backbottom="5%" backleft="2%" backright="10%">
...
sv.sv_libelle service_libelle,th.th_libelle technique_libelle,
...
while ($donnees=$reponse->fetch())
{
 ?>	
	<tr>
		...
		<td style="padding:5px 35px 5px 5px;border-right:1px solid black;width:160px;"><?php echo $donnees['jour_pre'].'/'.$donnees['mois_pre'].'/'.$donnees['annees_pre'];?></td>
		<td style="padding:5px 5px 5px 5px;border:1px solid black;">Test</td>
		<td style="padding:5px 5px 5px 5px;border:1px solid black;">Résultats</td>
	...
	<tr>
		...
		<td style="padding:5px 35px 5px 5px;border-right:1px solid black;width:160px;"><?php echo $donnees['libelle_projet'];?></td>
	...
	<tr>
		...
		<td style="padding:5px 35px 5px 5px;border-right:1px solid black;width:160px;"><?php echo $donnees['laboratoire'];?></td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;">2mg/l</td>
	...
	<tr>
		...
		<td style="padding:5px 35px 5px 5px;border-right:1px solid black;width:160px;"><?php echo $donnees['dossier'];?></td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;"></td>
	...
	<tr>
		...
		<td style="padding:5px 35px 5px 5px;border-right:1px solid black;width:160px;"><?php echo $donnees['nom'];?></td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;">0.96-2.70 g/L</td>
	...
	<tr>
	 ...
	 <td style="padding:5px 35px 5px 5px;border-right:1px solid black;width:160px;"><?php echo $donnees['prenom'];?></td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;">1,0-1,2 mg/L</td>
	...
	<tr>
		...
		<td style="padding:5px 35px 5px 5px;border-right:1px solid black;width:160px;"><?php echo $donnees['sexe'];?></td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;">0,74-1,10g/L</td>
	...
	<tr>
		...
		<td style="padding:5px 35px 5px 5px;border-right:1px solid black;width:160px;"><?php echo $donnees['age'];?></td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;">0,40-0,70g/L</td>
	...
	<tr>
		...
		<td style="padding:5px 35px 5px 5px;border-right:1px solid black;width:160px;"><?php echo $donnees['bilan'];?></td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;">1,50 g/L</td>
	...
	<tr>
		...
		<td style="padding:5px 35px 5px 5px;border-right:1px solid black;width:160px;"><?php echo $donnees['service_libelle'];?></td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;">61-76g/l</td>
	...
	<tr>
		...
		<td style="padding:5px 35px 5px 5px;border-right:1px solid black;width:160px;"><?php echo $donnees['prescripteur'];?></td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;">30-40 mg/L</td>
	...
	<tr>
		...
		<td style="padding:5px 35px 5px 5px;border-right:1px solid black;width:160px;"><?php echo $donnees['technique'];?></td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;">154 mg/L</td>
	...
	<tr>
		...
		<td style="padding:5px 35px 5px 5px;border-right:1px solid black;width:160px;"><?php echo $donnees['jour_ren'].'/'.$donnees['mois_ren'].'/'.$donnees['annees_ren'];?></td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;">0,4-1,65 g/L</td>
	...
	<tr>
		<td></td>
		<td style="padding:5px 5px 5px 5px;border-right:1px solid black;padding:5px 5px 5px 5px;width:160px;"></td>
		<td style="padding:5px 35px 5px 5px;border-left:1px solid black;border-right:1px solid black;">CO2:Bicarbonate</td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;">21-26mmol/L</td>
	...
	<tr>
		<td></td>
		<td style="padding:5px 5px 5px 5px;border-right:1px solid black;width:160px;"></td>
		<td style="padding:5px 35px 5px 5px;border-left:1px solid black;border-right:1px solid black;">NO3:Amoniac</td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;">0,5 mg/L</td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:5px 35px 5px 5px;border-left:1px solid black;border-right:1px solid black;">ACB:Acide bilaire</td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;">1,50 g/L</td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:5px 35px 5px 5px;border-left:1px solid black;border-right:1px solid black;">AU:Acide Unique</td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;">40-60 g/L</td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:5px 35px 5px 5px;border-left:1px solid black;border-right:1px solid black;">Créatinémie</td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;">6-16 mg/L</td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:5px 35px 5px 5px;border-left:1px solid black;border-right:1px solid black;">Créatinurie</td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;">H:15-25mg/Kg/24</td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:5px 35px 5px 5px;border-left:1px solid black;border-right:1px solid black;">FRY:frustosamine</td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;"></td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:5px 35px 5px 5px;border-left:1px solid black;border-right:1px solid black;">LAC:lactate</td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;"></td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:5px 35px 5px 5px;border-left:1px solid black;border-right:1px solid black;">URE:Urée</td>
...
<td style="padding:5px 5px 5px 5px;border-left:1px solid black;border-right:1px solid black;">0,1-0,5g/L</td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:2px 35px 2px 5px;border-left:1px solid black;border-right:1px solid black;">GOT/ASAT</td>
...
<td style="padding:2px 5px 2px 5px;border-left:1px solid black;border-right:1px solid black;">H:7-40;F;5-30UI/L</td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:2px 35px 2px 5px;border-left:1px solid black;border-right:1px solid black;">GPT/ALAT</td>
...
<td style="padding:2px 5px 2px 5px;border-left:1px solid black;border-right:1px solid black;">H:7-50;F;2-40UI/Ll</td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:2px 35px 2px 5px;border-left:1px solid black;border-right:1px solid black;">Amy:Amylasémie</td>
...
<td style="padding:2px 5px 2px 5px;border-left:1px solid black;border-right:1px solid black;">95 UI/L</td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:2px 35px 2px 5px;border-left:1px solid black;border-right:1px solid black;">CPK</td>
...
<td style="padding:2px 5px 2px 5px;border-left:1px solid black;border-right:1px solid black;">H:0-195/F:0-170 UI</td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:2px 35px 2px 5px;border-left:1px solid black;border-right:1px solid black;">GGT</td>
...
<td style="padding:2px 5px 2px 5px;border-left:1px solid black;border-right:1px solid black;">5-36 UI/L</td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:2px 35px 2px 5px;border-left:1px solid black;border-right:1px solid black;">LDH</td>
...
<td style="padding:2px 5px 2px 5px;border-left:1px solid black;border-right:1px solid black;">250 u.lip/l</td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:2px 35px 2px 5px;border-left:1px solid black;border-right:1px solid black;">Lipase</td>
...
<td style="padding:2px 5px 2px 5px;border-left:1px solid black;border-right:1px solid black;">250 UI/L</td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:2px 35px 2px 5px;border-left:1px solid black;border-right:1px solid black;">Calcium(Ca2+)</td>
...
<td style="padding:2px 5px 2px 5px;border-left:1px solid black;border-right:1px solid black;">90-104 mg/L</td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:2px 35px 2px 5px;border-left:1px solid black;border-right:1px solid black;">Chlore</td>
...
<td style="padding:2px 5px 2px 5px;border-left:1px solid black;border-right:1px solid black;">3,5-3,9 g/L</td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:2px 35px 2px 5px;border-left:1px solid black;border-right:1px solid black;">Magnésium(Mg2+)</td>
...
<td style="padding:2px 5px 2px 5px;border-left:1px solid black;border-right:1px solid black;">17-0,21 g/L</td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:2px 35px 2px 5px;border-left:1px solid black;border-right:1px solid black;">Potassium(K +)</td>
...
<td style="padding:2px 5px 2px 5px;border-left:1px solid black;border-right:1px solid black;">0,15-0,2 g/L</td>
	...
	<tr>
		<td></td>
		<td style="border-right:1px solid black;width:160px;"></td>
		<td style="padding:2px 35px 2px 5px;border-left:1px solid black;border-right:1px solid black;border-bottom:1px solid black;">Sodium(Na +)</td>
