...
<page backtop="0%" backbottom="5%" backleft="5%" backright="5%">
...
cv.cv_prescripteur prescripteur,cv.cv_technique technique,cv.cv_unite unite,cv.cv_chargevirale chargevirale,cv.cv_conclusion conclusion,cv.cv_commentaire remarque,sv.sv_libelle service_libelle,th.th_libelle technique_libelle,
...
while ($donnees=$reponse->fetch())
{
 ?>	
 <tr>
		<td colspan="2" style="padding-left:150px;padding-bottom:20px;font-size:20px;font-weight:bold;">CHARGES VIRALES</td>
	...
	<tr>
		...
		<td style="padding-bottom:10px;padding-right:10px;"><?php echo htmlentities($donnees['laboratoire']);?></td>
	</tr>
	<tr>
		<td style="padding-bottom:10px;padding-right:10px;font-weight:bold;"><?php echo 'Dossier:'  ?></td>
		<td style="padding-bottom:10px;padding-right:10px;"><?php echo htmlentities($donnees['dossier']);?></td>
	</tr>
	<tr>
...
<td style="padding-bottom:10px;padding-right:10px;font-weight:bold;"><?php echo 'Sexe:'  ?></td>
	...
	<tr>
		...
		<td style="padding-bottom:10px;padding-right:10px;"><?php echo htmlentities($donnees['technique']);?></td>
	</tr>
	<tr>
		<td style="padding-bottom:10px;padding-right:10px;font-weight:bold;"><?php echo 'Unités:'  ?></td>
		<td style="padding-bottom:10px;padding-right:10px;"><?php echo htmlentities($donnees['unite']);?></td>
	</tr>
	<tr>
		...
		<?php echo htmlentities($donnees['chargevirale']);?></td>
	</tr>
	<tr>
		<td style="padding-bottom:10px;padding-right:10px;font-weight:bold;"><?php echo 'Conclusion:'  ?></td>
		<td style="padding-bottom:10px;padding-right:10px;"><?php echo htmlentities($donnees['conclusion']);?></td>
	</tr>
	<tr>
		<td style="padding-bottom:10px;padding-right:10px;font-weight:bold;"><?php echo 'Remarques:'  ?></td>
		<td style="padding-bottom:10px;padding-right:10px;"><?php echo htmlentities($donnees['remarque']);?></td>
	</tr>
	<tr>
