...
?>
	...
	<tr class="success">
	<strong>	<td class="col-md-1" style="width:450px"><?php echo $donnees['dossier'];?>
		</td></strong>
		<td class="col-md-1" style="width:450px"><?php echo $donnees['jour_r'].'/'.$donnees['mois_r'].'/'.$donnees['annees_r'];?>
		</td>
		<td class="col-md-1" style="width:450px"><a target="_blank"href="page_bi_impression.php?page=<?php echo $donnees['bi_numero'];?>">Imprimer</a></td>
		<td class="col-md-1" style="width:450px"><a target="_blank"href="page_bi_suppression.php?page=<?php echo $donnees['bi_numero'];?>">Supprimer</a></td>
	</tr>
