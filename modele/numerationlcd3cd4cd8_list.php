...
?>
	...
	<tr  class="danger">
		<td class="col-md-2" style="width:450px"><?php echo $donnees['dossier'];?>
		</td>
		<td class="col-md-2" style="width:450px"><?php echo $donnees['jour_r'].'/'.$donnees['mois_r'].'/'.$donnees['annees_r'];?>
		</td>
			<td class="col-md-2" style="width:450px"><a target="_blank"href="page_nl_impression.php?page=<?php echo $donnees['nl_numero'];?>">Imprimer</a></td>
			<td class="col-md-2" style="width:450px"><a target="_blank"href="page_nl_suppression.php?page=<?php echo $donnees['nl_numero'];?>">Supprimer</a></td>
	</tr>
